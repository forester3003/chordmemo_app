// @ts-nocheck
// かなり前に作られたライブラリをそのままコピーしている
// 型追加も大変なので、一旦ts-nocheckをつけている
// A = 442Hz に変更している
...
(function () {
  ...
  let pack = (c, arg) => [new Uint8Array([arg, arg >> 8]), new Uint8Array([arg, arg >> 8, arg >> 16, arg >> 24])][c];
